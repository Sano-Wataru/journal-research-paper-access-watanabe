...
\begin{revisedblock}
%6
We report four-class and three-class confusion counts for experiment participant A.
%7
For normals with no clustering, pad operation yielded 172 false predictions as mouse operation.
  %7-1
...
%9
For normals with no clustering, pad-or-typing yielded 189 false predictions as mouse operation.
%10
Full confusion matrices for all twelve preprocessing configurations appear in the response letter.
\end{revisedblock}
