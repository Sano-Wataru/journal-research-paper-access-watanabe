...
\deleted{Tables~\ref{normalnonematrix} and \ref{normalkmeansmatrix} present representative confusion matrices for test subjects A to AB.}
\revised{Tables~\ref{normalnonematrix} and \ref{normalkmeansmatrix} present representative confusion matrices for test experiment participants A to AB.}
%
...
We compare two conditions to examine the effect of clustering.
  %
  The conditions are: normals with no clustering and normals with k-means.
%
Both of the used normals as features; however, the normals with no clustering tended to show higher accuracy, while the normals with k-means tended to show lower accuracy in Table~\ref{accresults}.
%
...
\input{tex/evaluation/confusion-matrices/table.tex}
}