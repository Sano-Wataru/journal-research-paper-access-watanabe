...
%
Both of the used normals as features; however, the normals without clustering tended to show higher accuracy, while the normals with k-means tended to show lower accuracy in Table~\ref{accresults}.
%
