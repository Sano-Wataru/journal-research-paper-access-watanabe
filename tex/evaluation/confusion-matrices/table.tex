...
\begin{table}[b]
  \centering
  \caption{Matrix of test results with normals and no clustering. Diagonal toward lower right corner is correct. Vertical columns represent number of labels inferred as mouse operation, pad operation, sitting still, and typing, respectively, from left to right. Horizontal rows represent, from top, number of labels where actual label is mouse operation, pad operation, sitting still, or typing.}
