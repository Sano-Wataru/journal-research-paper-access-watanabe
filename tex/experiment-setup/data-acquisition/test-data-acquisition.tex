...
\revised{Test data were acquired for the four posture classes under the conditions summarized in Table~\ref{dataacquisition}; each capture was performed once per subject.}
