...
\revised{The classification models trained using the augmented data from three experiment participants were evaluated using the test data from twenty-eight experiment participants.}
