...
%1st paragraph  Figs.~
%1提案
In light of the background, we propose an edge computing system that classifies the postures of people with hand movement in an office by using a LiDAR sensor network. 
    %1-1取得対象とデータの扱い
